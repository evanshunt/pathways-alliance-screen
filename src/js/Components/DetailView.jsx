...
export default forwardRef(({active}, ref) => {
  return (
    <group 
      ref={ref}
      position={[0,-20,0]}
    >
      <Html
        ...
        zIndexRange={[100, 0]}
      >
        <section className={active ? "detailview active" : "detailview inactive"}>
          <div className="content">
            ...
            <div className="illustration">
              <ul className="logos">
                <li><img src="/images/logos/canadian-natural.png" /></li>
                <li><img src="/images/logos/cenovus.png" /></li>
                <li><img src="/images/logos/conoco-phillips.png" /></li>
                <li><img src="/images/logos/imperial.png" /></li>
                <li><img src="/images/logos/meg.png" /></li>
                <li><img src="/images/logos/suncor.png" /></li>
              </ul>
            </div>
          </div>
        </section>
